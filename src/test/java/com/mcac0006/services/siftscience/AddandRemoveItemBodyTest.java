...
public class AddandRemoveItemBodyTest {
	...
	public void addItemToCartTest() throws JsonGenerationException, JsonMappingException, IOException {
		...
		final String json = SiftScienceHelper.DEFAULT.serialize(add_item_to_cart); // the json object we will be asserting
		...
		this.assertEquals(i.keySet(), iexpectedKeys);
	...
	public void removeItemFromCartTest() throws JsonGenerationException, JsonMappingException, IOException {
		...
		final String json = SiftScienceHelper.DEFAULT.serialize(remove_item_from_cart); // the json object we will be asserting
